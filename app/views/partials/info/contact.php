			...
			<div class="col-sm-7">
				<div class="panel panel-body">
					...
					<p>
						...
						<p class="adr clearfix">
							<span class="adr-group">
								<span class="street-address">Sentra Dianthus Harvest Boulevard</span><br>
								<span class="postal-code">104441</span><br>
								<span class="country-name">Cileungsi, Jawa Barat</span>
							</span>
						</p>
					</p>
					<hr />
					<p>
						...
						<span class="editContent"> 403/333</span>
					</p>
					<hr />

					<p>
						<b class="chead"><span class="material-icons">email</span> Email</b><br />
						<a href="#" class="editContent">adam@<?php echo SITE_NAME ?>.com</a>
					</p>
				</div>
			</div>
		</div>
