...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Task Daily</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("task_daily/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-Trouble"  value="<?php  echo $data['Trouble']; ?>" type="text" placeholder="Enter Trouble"  required="" name="Trouble"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <label class="custom-control custom-checkbox custom-control-inline option-btn">
                                                                <input id="ctrl-Status" class="custom-control-input" value="true" <?php echo $this->check_form_field_checked($data['Status'] , 'true'); ?> type="checkbox" required="" name="Status[]" />
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <div class="dropzone " input="#ctrl-Gambar" fieldname="Gambar"    data-multiple="false" dropmsg="Unggah_Gambar"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                    <input name="Gambar" id="ctrl-Gambar" class="dropzone-input form-control" value="<?php  echo $data['Gambar']; ?>" type="text"  />
