...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  User Login</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("user_login/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-Password"  value="<?php  echo $data['Password']; ?>" type="password" placeholder="Enter Password" maxlength="255" list="Password_list"  required="" name="Password"  class="form-control  password password-strength" />
                                                        ...
                                                        <datalist id="Password_list">
                                                            ...
                                                            $selected = ( $value == $field_value ? 'selected' : null );
                                                            ?>
                                                            <option><?php  echo $data['Password']; ?></option>
                                                            <?php
                                                            }
                                                            }
                                                            ?>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-email"  value="<?php  echo $data['email']; ?>" type="email" placeholder="Enter Email" list="email_list"  required="" name="email"  data-url="api/json/user_login_email_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-id_user"  value="<?php  echo $data['id_user']; ?>" type="text" placeholder="Enter Id User" list="id_user_list"  required="" name="id_user"  class="form-control " />
                                                                    <datalist id="id_user_list">
                                                                        <?php
                                                                        $id_user_options = Menu :: $username;
                                                                        $field_value = $data['id_user'];
